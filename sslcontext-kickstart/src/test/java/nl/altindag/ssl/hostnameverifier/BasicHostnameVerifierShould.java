...
class BasicHostnameVerifierShould {
    ...
    private final BasicHostNameVerifier hostnameVerifier = (BasicHostNameVerifier) BasicHostNameVerifier.getInstance();
    ...
    void verifyAsIpAddress() {
        // IPv4
        assertThat(hostnameVerifier.canParseAsIpAddress("127.0.0.1")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("1.2.3.4")).isTrue();

        // IPv6
        assertThat(hostnameVerifier.canParseAsIpAddress("::1")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("2001:db8::1")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("::192.168.0.1")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("::ffff:192.168.0.1")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("FEDC:BA98:7654:3210:FEDC:BA98:7654:3210")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("1080:0:0:0:8:800:200C:417A")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("1080::8:800:200C:417A")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("FF01::101")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("0:0:0:0:0:0:13.1.68.3")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("0:0:0:0:0:FFFF:129.144.52.38")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("::13.1.68.3")).isTrue();
        assertThat(hostnameVerifier.canParseAsIpAddress("::FFFF:129.144.52.38")).isTrue();

        // Hostnames
        assertThat(hostnameVerifier.canParseAsIpAddress("go")).isFalse();
        assertThat(hostnameVerifier.canParseAsIpAddress("localhost")).isFalse();
        assertThat(hostnameVerifier.canParseAsIpAddress("squareup.com")).isFalse();
        assertThat(hostnameVerifier.canParseAsIpAddress("www.nintendo.co.jp")).isFalse();
    }
