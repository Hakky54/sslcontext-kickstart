 ...
 */
class ChainAndAuthTypeWithSocketValidatorShould {
    ...
    void test() {
        ...
        ChainAndAuthTypeWithSocketValidator validator = (X509Certificate[] certificateChain, String authType, Socket socket) -> certificateChain[0].getSubjectX500Principal().getName().contains("Google");
