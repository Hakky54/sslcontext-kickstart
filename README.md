...
### Install with Gradle
```groovy
implementation 'io.github.hakky54:sslcontext-kickstart:7.4.2'
```
...
```
libraryDependencies += "io.github.hakky54" % "sslcontext-kickstart" % "7.4.2"
```
### Install with Apache Ivy
```xml
<dependency org="io.github.hakky54" name="sslcontext-kickstart" rev="7.4.2" />
```
