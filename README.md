...
### Install with Gradle
```groovy
implementation 'io.github.hakky54:sslcontext-kickstart:8.3.1'
```
...
```
libraryDependencies += "io.github.hakky54" % "sslcontext-kickstart" % "8.3.1"
```
### Install with Apache Ivy
```xml

<dependency org="io.github.hakky54" name="sslcontext-kickstart" rev="8.3.1"/>
```
