...
### Install with Gradle
```groovy
implementation 'io.github.hakky54:sslcontext-kickstart:8.1.7'
```
...
```
libraryDependencies += "io.github.hakky54" % "sslcontext-kickstart" % "8.1.7"
```
### Install with Apache Ivy
```xml

<dependency org="io.github.hakky54" name="sslcontext-kickstart" rev="8.1.7"/>
```
