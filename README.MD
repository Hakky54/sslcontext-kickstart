...
[![SonarCloud](https://sonarcloud.io/images/project_badges/sonarcloud-white.svg)](https://sonarcloud.io/dashboard?id=io.github.hakky54%3Asslcontext-kickstart-parent) [![Join the chat at https://gitter.im/hakky54/Sslcontext-kickstart](https://badges.gitter.im/hakky54/Sslcontext-kickstart.svg)](https://gitter.im/hakky54/Sslcontext-kickstart?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
### Install with Gradle
```groovy
implementation 'io.github.hakky54:sslcontext-kickstart:3.1.0'
```
### Install with Scala SBT
```
libraryDependencies += "io.github.hakky54" % "sslcontext-kickstart" % "3.1.0"
```
### Install with Apache Ivy
```xml
<dependency org="io.github.hakky54" name="sslcontext-kickstart" rev="3.1.0" />
```
