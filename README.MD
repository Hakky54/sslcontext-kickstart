...
### Install with Gradle
```groovy
implementation 'io.github.hakky54:sslcontext-kickstart:6.4.0'
```
### Install with Scala SBT
```
libraryDependencies += "io.github.hakky54" % "sslcontext-kickstart" % "6.4.0"
```
### Install with Apache Ivy
```xml
<dependency org="io.github.hakky54" name="sslcontext-kickstart" rev="6.4.0" />
```
...
SSLSessionUtils.invalidateCachesBetween(
        ...
        ZonedDateTime.of(LocalDateTime.of(2021, Month.JANUARY, 1, 15, 55), ZoneOffset.UTC),
        ZonedDateTime.of(LocalDateTime.of(2021, Month.FEBRUARY, 10, 8, 14), ZoneOffset.UTC)
);
```
#### Using PEM Files
